...
const BAR_CLASSES: Record<BarTone, string> = {
  committed:   "h-7 rounded-full bg-terracotta-300/90 px-3.5 py-1 text-[12px] tracking-wide text-cream-50 leading-tight",
  "in-flight": "h-7 rounded-full bg-ink/85 px-3.5 py-1 text-[12px] tracking-wide text-cream-50 leading-tight",
  exploratory: "h-7 rounded-full border border-ink/30 bg-cream-50 px-3.5 py-1 text-[12px] tracking-wide text-ink leading-tight",
};
    ...
    <SlideFit>
      <div ref={root} className="w-[1280px] max-w-[88vw]">
        ...
        <div data-anim className="mt-12 border border-ink/15 bg-cream-50/60">
          <div className="grid grid-cols-[140px_repeat(4,1fr)] border-b border-ink/12 text-[11px] uppercase tracking-[0.22em] text-ink/55">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 px-4 py-6">
                  <span data-pop className="display text-terracotta-300 text-[20px]">{lane.roman}</span>
                  <span className="text-[13px] text-ink/80">{lane.name}</span>
                </div>
        ...
        <div data-anim className="mt-5 flex items-center gap-6 text-[11px] uppercase tracking-[0.22em] text-ink/50">
